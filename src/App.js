...
const ServicesSection = () => (
  ...
  >
    ...
    <div style={{ fontSize: "3rem", fontFamily: '"Open Sans", arial, sans-serif'}}>
    <p style={{ fontSize: "1.1rem", fontWeight: "normal", color: 'rgb(94, 94, 94)' }}>
      Confused by the world of health insurance? We are here to walk you through
      them, step by step.
    </p>
    <p style={{ fontSize: "1.1rem", fontWeight: "normal", color: 'rgb(94, 94, 94)' }}>
    We help you filter through your plan options in a way that you can understand.
    </p>
    <p style={{ fontSize: "1.1rem", fontWeight: "normal", color: 'rgb(94, 94, 94)'  }}>
    Our team brings together our experience & knowledge with your unique circumstance to craft a program that is specific to your wants, needs, health, and wallet. 
    </p>
    </div>
    <br></br>
    <br></br>
    <h1 style={{ fontSize: "3rem", fontWeight: "normal", color: 'rgb(94, 94, 94)', fontFamily: '"Playfair Display", Georgia, serif' }}>
    Why Choose us?
    </h1>
    <div
      style={{
