...
const HeroSection = () => (
  <section style={{ textAlign: "center", padding: "80px 20px", backgroundColor: "#1a202c", color: "white" }}>
    ...
    <img src="/logo.png" alt="Company Logo" style={{ width: "60%", 'border-radius': '85px' }} />
...
const ContactSection = () => (
  <section style={{ padding: "50px 20px", backgroundColor: "#e2e8f0", textAlign: "center" }}>
    ...
    <p style={{ fontSize: "1rem", fontWeight: "bold", color: "#4a5568" }}>Email: info@atpconsultingservices.com</p>
